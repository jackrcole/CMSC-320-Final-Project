...
alc_data <- read_html("https://en.wikipedia.org/wiki/List_of_countries_by_alcohol_consumption_per_capita")
...
sui_df <- read_csv("~/Desktop/data.csv")
...
In this section we will run a simple linear regresssion to see what trends we can establish from our visualization.
